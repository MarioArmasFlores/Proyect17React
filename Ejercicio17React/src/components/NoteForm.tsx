...
export function NoteForm({ onSubmit, onAddTag, availableTags }: NoteFormProps) { //componente
                ...
                <Row> {/* etiqueta row para crear fila, tambien de bootstrap grid. */}
                    <Col> {/* etiqueta para crear columna */}
                        <Form.Group controlId="title"> {/* Form group es para agrupar los elementos relacionados del form. */}
                            ...
                            <Form.Control ref={titleRef} required /> {/* form control es el input tipo texto. Cuya ref es el useRef "titleRef" - Required indica que el campo debe llenarse si o si */}
                        </Form.Group>
